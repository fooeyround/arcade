...
public object ReplayChunkRecorders {
    private val recorders = LinkedHashMap<String, ReplayChunkRecorder>()
    private val closing = HashSet<ReplayChunkRecorder>()
     ...
     * @param format The format to write the replay in.
    ...
    public fun create(
        ...
        val recorder = ReplayChunkRecorder(area, name, settings, settings.format.writer(directory.resolve(name)))
